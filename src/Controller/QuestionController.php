...
class QuestionController extends AbstractController
{
    ...
    public function show(Request $request, int $id, EntityManagerInterface $em, QuestionRepository $questionRepo): Response
    {
    ...
    public function rating_question(Question $question, Request $request, int $score, EntityManagerInterface $em, VoteRepository $voteRepo)
    {
    ...
    #[IsGranted('IS_AUTHENTICATED_REMEMBERED')]
    public function rating_comment(Comment $comment, Request $request, int $score, EntityManagerInterface $em, VoteRepository $voteRepo)
    {
        $user = $this->getUser();
